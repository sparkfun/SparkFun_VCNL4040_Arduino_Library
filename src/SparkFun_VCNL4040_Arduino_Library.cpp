...
static const uint8_t VCNL4040_ALS_IT_MASK = (byte)~((1 << 7) | (1 << 6));
...
static const uint8_t VCNL4040_ALS_PERS_MASK = (byte)~((1 << 3) | (1 << 2));
...
static const uint8_t VCNL4040_PS_PERS_MASK = (byte)~((1 << 5) | (1 << 4));
...
static const uint8_t VCNL4040_PS_IT_MASK = (byte)~((1 << 3) | (1 << 2) | (1 << 1));
...
void VCNL4040::setAmbientIntegrationTime(uint8_t timeValue)
{
